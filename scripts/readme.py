...
class Config:
    ...
    local_path = 'C:\Users\rapha\Documents\code\leetcode'

    # solution of leetcode

    github_leetcode_url = 'https://github.com/raphaelli/leetcode/blob/master/leetcode-algorithms/'

    # solution of pat,　暂时还没写

    github_pat_url = 'https://github.com/raphaelli/leetcode/blob/master/leetcode-algorithms/'
